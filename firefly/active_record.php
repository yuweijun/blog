...
abstract class ActiveRecord {
	 ...
	 */
	private static $slave_connection = null;
	...
	public static function establish_connection($config) {
		...
		return call_user_func(array($config['adapter'], 'establish_connection'), $config['host'], $config['username'], $config['password'], $config['database']);
	}
