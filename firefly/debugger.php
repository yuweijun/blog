<?php
class Debugger {
	private static $include_js_css = false;
	 ...
	 */
	private static function init_js_css() {
		echo "
			...
			<style type='text/css'>
				table.debug_array,table.debug_object,table.debug_resource {
					font-family:Verdana, Arial, Helvetica, sans-serif; color:#000; font-size:12px;width:100%;
				}

				.debug_array_header,
				.debug_object_header,
				.debug_resource_header { font-weight:bold; color:#fff; cursor:pointer; }

				.debug_array_key,
				.debug_object_key { cursor:pointer; }

				/* array */
				table.debug_array { background-color:#060; }
				table.debug_array td { background-color:#fff; }
				table.debug_array td.debug_array_header { background-color:#090; }
				table.debug_array td.debug_array_key { background-color:#cfc; }

				/* object */
				table.debug_object { background-color:#00c; }
				table.debug_object td { background-color:#fff; }
				table.debug_object td.debug_object_header { background-color:#44c; }
				table.debug_object td.debug_object_key { background-color:#cdf; }

				/* resource */
				table.debug_resource { background-color:#848; }
				table.debug_resource td { background-color:#fff; }
				table.debug_resource td.debug_resource_header { background-color:#a6a; }
				table.debug_resource td.debug_resource_key { background-color:#fdf; }
			</style>
		";
	}
