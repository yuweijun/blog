...
class Helpers {
	...
	/**
	 * Helper with $controller_name has the highest priovity except firefly_helper.php,
	 * then helpers include by controller has normal priovity,
	 * application heplers has the lowest priovity.
	 */
	public static function include_helpers($controller_name, $helpers) {
		include_once('firefly_helper.php');
	...
	private static function include_helper_file($helper_file) {
		...
		$app_helers_path = FIREFLY_APP_DIR . DS . 'helpers' . DS . $file_name;
