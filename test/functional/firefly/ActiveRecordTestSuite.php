...
require_once('ActiveRecordCalculateTest.php');

class ActiveRecordTestSuite extends PHPUnit_Framework_TestSuite {
	public static function suite() {
		$suite = new ActiveRecordTestSuite('ActiveRecordFindTest');
		...
		$suite->addTestSuite("ActiveRecordCalculateTest");
		return $suite;
	}
